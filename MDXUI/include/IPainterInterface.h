...
namespace DxUI{
	...
	struct IPainterInterface{
		...
		virtual void	DrawLinesForCross(const std::vector<DxPointD>& points, const DxColor& col, double Size) = 0;

		//
		// 可以给顶点指定颜色
		//
		virtual void	DrawLinesForPoint(const std::vector<DxPointD>& points, const DxColor& col, const DxColor& Markcol, double Size) = 0;
		virtual void	DrawLinesForCross(const std::vector<DxPointD>& points, const DxColor& col, const DxColor& Markcol, double Size) = 0;
